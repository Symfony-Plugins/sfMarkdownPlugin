 ...
 * @author          Kiril Angov <kupokomapa@gmail.com>
...
/**
 * @see Markdownify_Extra
 */
require_once sfConfig::get('sf_markdownify_parser_lib');
 ...
 * @license         http://www.symfony-project.com/content/license.html
 */
class sfMarkdownify extends Markdownify_Extra
{
  /**
  ...
  {
    $class = sfConfig::get('sf_markdownify_parser', 'Markdownify_Extra');
   ...
   *
   * This function converts given HTML to Markdown text.
   *
   * @param   string  $text
   * @return  string
   */
   ...
   *
   * This function converts given HTML to Markdown text.
   * It's just a convenient static shortcut for sfMarkdownify::convert()
   *
   * @param   string  $text
   * @return  string
   * @see     sfMarkdownify::parseString()
   * @static
   */
  ...
  /**
   * Returns a Markdownify Parser instance
   *
   * @return  mixed   Markdownify parser instance
   */
